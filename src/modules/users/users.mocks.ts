// Static fallbacks for dashboard charts that require data we don't yet capture.
// Replace these with real aggregations once the corresponding events/profile
// fields are tracked (session activity logs, user age/demographics).
